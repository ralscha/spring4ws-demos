...
SockJS.websocket = _dereq_('./trans-websocket');
SockJS['iframe-eventsource'] = _dereq_('./trans-iframe-eventsource');
SockJS['iframe-htmlfile'] = _dereq_('./trans-iframe-htmlfile');
SockJS['iframe-xhr-polling'] = _dereq_('./trans-iframe-xhr-polling');
SockJS['jsonp-polling'] = _dereq_('./trans-jsonp-polling');
SockJS['xdr-polling'] = XDRPolling;
SockJS['xdr-streaming'] = _dereq_('./trans-xdr-streaming');
SockJS['xhr-polling'] = _dereq_('./trans-xhr-polling');
SockJS['xhr-streaming'] = _dereq_('./trans-xhr-streaming');
